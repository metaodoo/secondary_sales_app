      ...
      MenuSection('Fulfillment', [
        ...
        MenuDestination(
          ...
          builder: (_) => const ReturnsListScreen(
            ...
            createLabel: 'New Saleable Return',
            createScreenTitle: 'Saleable Return',
            productSelectionTitle: 'Select Saleable Return Products',
        ...
        MenuDestination(
          ...
          builder: (_) => const ScrapsListScreen(
            ...
            createLabel: 'New Non-Saleable Return',
            createScreenTitle: 'Non-Saleable Return',
            productSelectionTitle: 'Select Non-Saleable Return Products',
          ),
        ),
      ]),
    );
