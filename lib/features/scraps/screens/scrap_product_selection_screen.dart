...
class ScrapProductSelectionScreen extends StatefulWidget {
  const ScrapProductSelectionScreen({
    super.key,
  ...
  State<ScrapProductSelectionScreen> createState() =>
      _ScrapProductSelectionScreenState();
}

class _ScrapProductSelectionScreenState
    extends State<ScrapProductSelectionScreen> {
  ...
  Future<void> _fetchProducts() async {
    ...
    final results = await context.read<ScrapProvider>().getScrapProducts(
    ...
    setState(() {
      _isLoading = false;
      _products =
          results?.map((e) => TransferProduct.fromMap(e)).toList() ?? [];
    });
  }
